...
public abstract class BrakeModel extends TurboBaseModel {
  ...
  public double getResistance() {
    return ((double) (getAbsoluteResistance() - resitanceLowLimit) / (double)
        (resistanceHighLimit - resitanceLowLimit)) * 100.0;
  }
  ...
  public void setResistance(double resistance) {
    ...
    int absolute = (int) (((resistance / 100) * (resistanceHighLimit - resitanceLowLimit)) +
        resitanceLowLimit);
