...
public abstract class AbstractController implements TurboTrainerDataHooks {
  ...
  /**
   * Default implementation passes value back unchanged, see:
   * {@link TurboTrainerDataHooks#onSpeedChange(double)}
   */
  @Override
  ...
  /**
   * Default implementation passes value back unchanged, see:
   * {@link TurboTrainerDataHooks#onPowerChange(double)}
   */
  @Override
  ...
  /**
   * Default implementation passes value back unchanged, see:
   * {@link TurboTrainerDataHooks#onCadenceChange(double)}
   */
  @Override
  ...
  /**
   * Default implementation passes value back unchanged, see:
   * {@link TurboTrainerDataHooks#onDistanceChange(double)}
   */
  @Override
  ...
  /**
   * Must return non-null value if you want to use {@link AbstractController#logToCsv(String,
   * Object))
   *
