...
public interface TurboTrainerInterface {
   ...
   * @throws TimeoutException can communicate with turbo trainer but it is not responding in a
   * reasonable timeframe
   * @throws IllegalStateException if mode is invalid
   */
  public abstract void start() throws TurboCommunicationException, InterruptedException,
