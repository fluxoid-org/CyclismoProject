...
import static org.cowboycoders.cyclismo.content.ContentTypeIds.STRING_TYPE_ID;
...
public interface CourseWaypointsColumns extends BaseColumns {
  ...
  public static final String TOTALWORKDONE = "totalworkdone";
  public static final String TOTALCRANKROTATIONS = "totalcrankrotations";
  public static final String TOTALHEARTBEATS = "totalheartbeats";
  ...
  public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" 
      ...
      + TOTALWORKDONE + " FLOAT, " // TODO: Why are these floats?
  ...
  public static final byte[] COLUMN_TYPES = {
      ...
      FLOAT_TYPE_ID, // total useful work done
      FLOAT_TYPE_ID, // total crank revs
      FLOAT_TYPE_ID, // total heart beats
